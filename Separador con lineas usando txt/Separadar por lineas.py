...
ruta_ops = r"C:\Users\Ruddyard\Desktop\ProyEnGit\Separador con lineas usando txt\Archivos de diccionario\operadores\operadores.txt"
ruta_prs = r"C:\Users\Ruddyard\Desktop\ProyEnGit\Separador con lineas usando txt\Archivos de diccionario\palabras reservadas\palabrasReservadas.txt"
ruta_ptn = r"C:\Users\Ruddyard\Desktop\ProyEnGit\Separador con lineas usando txt\Archivos de diccionario\patrones\patrones.txt"
...
def Separar_Token(cTexto, cClasificar):
    tokens_result = []
    ...
    for num_linea, clineas in enumerate(alineas, 1):
        ...
        for cPalabra in aTokens:
            if cClasificar:
                ...
                # PRIMERO verificar si es palabra 
